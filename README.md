...
**Residência em TIC 29 - Web 3.0 | Projeto Final: Atividade Avançada VR**
...
1. **Locomoção Fluid:** Sistema de locomoção contínua para exploração técnica.
2. **Interação Ciberfísica:** Uso de *Socket Interactors* para encaixe preciso de hardware (manutenção simulada).
